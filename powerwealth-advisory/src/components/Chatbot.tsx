...
const ai = new GoogleGenAI({ apiKey: "AIzaSyDdPCxXR-5xiqHdDbJOqtHhH6pi2qHlpSk" });
...
export default function Chatbot() {
  ...
  const [messages, setMessages] = useState<{role: 'user' | 'model', text: string}[]>([
    { role: 'model', text: 'Hello. I am the Powerwealth advisory assistant. How can I help you understand our services or approach?' }
  ]);
