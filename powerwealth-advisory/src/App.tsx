...
import BW5Analysis from './pages/BW5Analysis';
    ...
    <div className="min-h-screen bg-white font-sans text-brand-dark selection:bg-brand-navy selection:text-white">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center">
            ...
            <div className="hidden lg:flex items-center space-x-8">
              ...
              <Link to="/bw5-analysis" className="text-[11px] font-mono font-bold tracking-[0.15em] uppercase text-brand-cyan hover:text-white transition-colors">
                BW5 Analysis →
              </Link>
      ...
      {mobileMenuOpen && (
        <div className="fixed inset-0 z-40 bg-brand-navy pt-24 px-4 border-t border-white/10">
          <div className="flex flex-col space-y-0">
            ...
            <Link to="/bw5-analysis" onClick={() => setMobileMenuOpen(false)} className="text-sm font-mono font-bold text-brand-cyan uppercase tracking-[0.15em] py-6 border-b border-white/10">
              BW5 Analysis →
            </Link>
      ...
      <main>
        <Routes>
          ...
          <Route path="/bw5-analysis" element={<BW5Analysis />} />
        </Routes>
      </main>
